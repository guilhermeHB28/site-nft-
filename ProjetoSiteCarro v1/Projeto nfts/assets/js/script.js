...
function setSlider() {
    ...
    if (active === 0) {
        container.style.backgroundImage = 'radial-gradient(circle, #FFD700, #404040 )';
        ...
        container.style.backgroundImage = 'radial-gradient(circle, #FF4500, #2F2F2F)';
        ...
        container.style.backgroundImage = 'radial-gradient(circle, #FF6F61, #003366)';
